...
public class CurrentValueWindow extends JFrame {
	...
	public void inits() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CurrentValueWindow frame = new CurrentValueWindow();
	...
	public CurrentValueWindow() {
		...
		JInternalFrame ValueBSInternalFrame = new JInternalFrame("\u0421\u0442\u043E\u0439\u043D\u043E\u0441\u0442 \u043D\u0430 \u041D\u0421");
		...
		JLabel CurrentValueLabel = new JLabel("\u041D\u0430\u0441\u0442\u043E\u044F\u0449\u0430 \u0441\u0442\u043E\u0439\u043D\u043E\u0441\u0442 \u043D\u0430 \u043F\u0430\u0440\u0438\u0442\u0435");
		CurrentValueLabel.setBounds(155, 11, 205, 14);
		contentPane.add(CurrentValueLabel);
		...
		Calculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            ...
	            Ko= (K*(1/Math.pow((1+r),n)));
	            Ka= (K*(1-(1/(Math.pow((1+r),n))))/r);
	            Kd= (Ka*(1+r));
		...
		Calculate.setBounds(155, 206, 130, 23);
		...
		JLabel lblNewLabel_8 = new JLabel("\u041D\u0421 - \u041D\u0430\u0441\u0442\u043E\u044F\u0449\u0430 \u0441\u0442\u043E\u0439\u043D\u043E\u0441\u0442");
